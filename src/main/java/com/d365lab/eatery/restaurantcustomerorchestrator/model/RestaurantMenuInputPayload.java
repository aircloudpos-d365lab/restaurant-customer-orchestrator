...
public class RestaurantMenuInputPayload implements Serializable {
    ...
    public RestaurantMenuInputPayload() {
    }

    public RestaurantMenuInputPayload(Integer restaurantMenuId, String restaurantTenantId, String restaurantMenuName, String restaurantMenuDescription, String restaurantMenuType, String restaurantMenuCategory, String restaurantMenuPhoto, Double restaurantMenuPrice, Double restaurantMenuPriceCgstPercentage, Double restaurantMenuPriceSgstPercentage, String restaurantMenuCustomizationList, Integer isMenuDisabled) {
